        ...
        echo 
            ...
            <form method='post' id='sectionData' action='sectionAdd_handle.php'>
                <div class='form-group'>
                    ...
                    <label for='input' class='control-label'>분반</label><i class='bar'></i>
                </div>
                <div class='form-group'>
                    <input type='text' name='year' required='required'/>
                    <label for='input' class='control-label'>개설년도</label><i class='bar'></i>
                </div>
                <div class='form-radio'>
                    ...
                    <div class='radio'>
                        ...
                        <input type='radio' name='semester' checked='checked'/><i class='helper' value=1 /></i>1
                            ...
                            <div class='radio'>
                        <label>
                        <input type='radio' name='semester' value=2 /><i class='helper'></i>2
                        </label>
                    </div>
                </div>
                <div class='form-group'>
                ...
                <div class='button-container'>
                    <button type='button' onClick='sectionButton()' class='button'><span>섹션 추가</span></button>
                </div>
            </form>
            </div>";
    }
