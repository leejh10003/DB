...
<?php
    ...
    $column_num = pg_num_fields($result);
     ...
     echo "<h2>과제량: " . $avg_assignment . " 성취감: " . $avg_achievement . " 학습량: " . $avg_learning . " 시험 난이도: " . $avg_test_difficulty . "</h2>"; 
        ...
        echo "<tr>";
            ...
            if($_SESSION['level'] > 1){
                echo "<td><a href='deleteEvaluation.php?member_id=" . $line['member_id'] . "&course_id=" . $course_id . "&sec_id=" . $sec_id . "&year=" . $year . "&semester=" . $semester . "'><svg style='width:24px;height:24px' viewBox='0 0 24 24'>
    ...
    <div id="container-floating">
      ...
      <?php
        ...
        if(!pg_fetch_array($member_existence, null, PGSQL_ASSOC)['member_id']){
            echo "<div class='nd4 nds' data-toggle='tooltip' data-placement='left' data-original-title='Reminder'>
        <svg style='margin-top:8px;margin-left:8px;width:24px;height:24px' viewBox='0 0 24 24' onClick='location.href=\"write.php?course_id=" . $course_id . "&sec_id=" . $sec_id . "&year=" . $year . "&semester=" . $semester . "\"'>
            ...
            echo "<div class='nd4 nds' data-toggle='tooltip' data-placement='left' data-original-title='Reminder'>
        <svg style='margin-top:8px;margin-left:8px;width:24px;height:24px' viewBox='0 0 24 24'>
            <path fill='#777777' d='M19,2L14,6.5V17.5L19,13V2M6.5,5C4.55,5 2.45,5.4 1,6.5V21.16C1,21.41 1.25,21.66 1.5,21.66C1.6,21.66 1.65,21.59 1.75,21.59C3.1,20.94 5.05,20.5 6.5,20.5C8.45,20.5 10.55,20.9 12,22C13.35,21.15 15.8,20.5 17.5,20.5C19.15,20.5 20.85,20.81 22.25,21.56C22.35,21.61 22.4,21.59 22.5,21.59C22.75,21.59 23,21.34 23,21.09V6.5C22.4,6.05 21.75,5.75 21,5.5V7.5L21,13V19C19.9,18.65 18.7,18.5 17.5,18.5C15.8,18.5 13.35,19.15 12,20V13L12,8.5V6.5C10.55,5.4 8.45,5 6.5,5V5Z' />
        </svg>
      </div>";
        }
      ?>
