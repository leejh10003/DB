                    ...
                    <div class='form-radio'>
                        <div class='radio'>
                            ...
                            <input type='radio' name='assignment_amount' checked='checked'/><i class='helper' value=1 /></i>1
                                ...
                                <div class='radio'>
                            <label>
                            <input type='radio' name='assignment_amount' value=2 /><i class='helper'></i>2
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='assignment_amount' value=3 /><i class='helper'></i>3
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='assignment_amount' value=4 /><i class='helper'></i>4
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='assignment_amount' value=5 /><i class='helper'></i>5
                            </label>
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class='form-radio'>
                        <div class='radio'>
                            ...
                            <input type='radio' name='achievement' checked='checked'/><i class='helper' value=1 /></i>1
                                ...
                                <div class='radio'>
                            <label>
                            <input type='radio' name='achievement' value=2 /><i class='helper'></i>2
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='achievement' value=3 /><i class='helper'></i>3
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='achievement' value=4 /><i class='helper'></i>4
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='achievement' value=5 /><i class='helper'></i>5
                            </label>
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class='form-radio'>
                        <div class='radio'>
                            ...
                            <input type='radio' name='learning' checked='checked'/><i class='helper' value=1 /></i>1
                                ...
                                <div class='radio'>
                            <label>
                            <input type='radio' name='learning' value=2 /><i class='helper'></i>2
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='learning' value=3 /><i class='helper'></i>3
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='learning' value=4 /><i class='helper'></i>4
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='learning' value=5 /><i class='helper'></i>5
                            </label>
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class='form-radio'>
                        <div class='radio'>
                            ...
                            <input type='radio' name='test_difficulty' checked='checked'/><i class='helper' value=1 /></i>1
                                ...
                                <div class='radio'>
                            <label>
                            <input type='radio' name='test_difficulty' value=2 /><i class='helper'></i>2
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='test_difficulty' value=3 /><i class='helper'></i>3
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='test_difficulty' value=4 /><i class='helper'></i>4
                            </label>
                        </div>
                                <div class='radio'>
                            <label>
                            <input type='radio' name='test_difficulty' value=5 /><i class='helper'></i>5
                            </label>
                        </div>
                    </div>
                    <div class='form-group'>
                        <input type='text' name='comment' required='required'/>
                        <label for='input' class='control-label'>의견</label><i class='bar'></i>
                    </div>
                    <div class='button-container'>
                        <button type='button' onClick='writeButton()' class='button'><span>평가</span></button>
                    </div>
                </form></div>";
        }
    }
